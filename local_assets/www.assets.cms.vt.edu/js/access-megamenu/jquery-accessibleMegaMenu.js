            ...
            if (topli.length === 1
                ...
                if (!target.hasClass(this.settings.openClass)) {
                    ...
                    if (this.justFocused) {
                        ...
                        //event.preventDefault(); //commented out to make parent links work in main nav for touch
                        //event.stopPropagation(); //commented out to make parent links work in main nav for touch
